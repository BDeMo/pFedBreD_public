...
print(fashion_data[0][0].shape, fashion_data[0][1].shape, fashion_data[1][0].shape, fashion_data[1][1].shape)
mnist_data_image = []
mnist_data_lable = []
mnist_data_image.extend(fashion_data[0][0])
mnist_data_image.extend(fashion_data[1][0])
mnist_data_lable.extend(fashion_data[0][1])
mnist_data_lable.extend(fashion_data[1][1])
